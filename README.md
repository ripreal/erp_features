...
7. Запускает внешнюю обработку ADD на копии и прогоняем тесты
...
Теперь запускаем сборку и ждем ее полного выполнения. Что делать, если пайплайн зависает на шаге с запуском BDD тестов - скорее всего всплыло какое-то модальное окошко, блокирующее дальнейшую раьоту
