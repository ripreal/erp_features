...
Функция СоздатьСервернуюБазу1С()
    ...
    ПараметрыСУБД.Вставить("СерверСУБД", СЕРВЕР);
    ...
    Конфигуратор.СоздатьСервернуюБазу(ПараметрыБазы1С, ПараметрыСУБД, АвторизацияВКластере, Ложь, ПУТЬ_К_ФАЙЛУ_БАЗЫ, БАЗА);
